...
Experiment with caching loadable files in a hash, so @Kernel#require@ works much faster. It should also works with RubyGems. Inspirated by http://gist.github.com/234467
